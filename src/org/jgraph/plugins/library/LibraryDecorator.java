...
import org.jgraph.pad.jgraphpad.GPDocument;
...
import org.microplatform.loaders.PluginInvoker.IDocAwarePlugin;

public class LibraryDecorator implements IDocAwarePlugin {
    ...
    public void setDocument(Document doc) {
    	GPDocument document = (GPDocument) doc;
        libraryExpanded = new Boolean(Translator.getString("LibraryExpanded"))
                .booleanValue();
        libraryPanel = createLibrary(document.getMdiContainer());
        gpOverviewPanel = new GPOverviewPanel(document
                .getGraph(), document);
        JPanel overviewPane = GPOverviewPanel.createOverviewPanel(document.getGraph(), document, gpOverviewPanel);
    ...
    private GPLibraryPanel createLibrary(MDIContainer graphpad) {
